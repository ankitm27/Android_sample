...
public class openTrendCustomerDetailFragment extends Fragment {
    String TAG="openTrendCustomerDetailFragment";
    ...
    public static openTrendCustomerDetailFragment newInstance() {
        return new openTrendCustomerDetailFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.d("@@@@@@@@@", "openTrendCustomerDetailFragment");
        ...
        crImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getFragmentManager() != null) {
                    ...
                    Fragment cutomerFragment = new openTrendCustomerDetailFragment();
...
//                dataTableT[2]="2";
    ...
    TableFixHeaderAdapter.ClickListener<NexusWithImage, OriginalBodyCellViewGroup> setClickListenerBody = new TableFixHeaderAdapter.ClickListener<NexusWithImage, OriginalBodyCellViewGroup>() {
        ...
        public void onClickItem(NexusWithImage item, OriginalBodyCellViewGroup viewGroup, int row, int column) {
            ...
            Intent myIntent = new Intent(getActivity(), openOrderInvoiceDetailActivity.class);
//                Bundle bundle = new Bundle();
//                bundle.putString("StateName", stateName);
