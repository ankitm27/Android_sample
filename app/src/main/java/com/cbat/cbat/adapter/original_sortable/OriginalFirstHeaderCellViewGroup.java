...
//        });
    ...
    private void drawOrderArrows(int order) {
       ...
       // iv_order_desc.setImageResource(order == -1 ? R.drawable.ic_arrow_drop_up_24dp : R.drawable.ic_arrow_drop_up_24dp_disabled);
        ...
        iv_order_desc.setImageResource(order == -1 ? R.drawable.up_orange_48 : R.drawable.up_grey_48);
        iv_order_asc.setImageResource(order == 1 ? R.drawable.down_orange_48 : R.drawable.down_grey_48);
